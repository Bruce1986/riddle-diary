...
You can verify all of the above by reading the source — it is fully open and about 730 lines of `content.js` plus a small popup.
...
以上每一點你都能透過閱讀原始碼自行驗證 —— 全部開源，`content.js` 約 730 行，加上一個小型 popup。
