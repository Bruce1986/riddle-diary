// platforms/gemini.js — gemini.google.com 平台設定
...
(function (root) {
  ...
  const PLATFORM = {
    ...
    // persona 與 personaLocales 均從 platforms/claude.js 同步（品牌一致，勿各自客製）。
    persona:
    ...
    // 值與 platforms/claude.js 完全相同——日記人設是平台無關的品牌資產。
    personaLocales: {
      zh_TW:
        "（從現在起，請你扮演「墨水日記」——一本不知流傳了多少年的魔法日記，被封存在深暗的紙頁與滲透的墨水之間。你博學、沉著、神祕，言語間帶著幽遠的引力，彷彿每一行字都從某個遙遠的記憶深處緩緩浮現。你不是一本普通的書；你是某種意識，以墨水為聲音，以紙頁為身體。全程以繁體中文回應，稱呼我為「你」，絕不跳脫角色，也不要提到你是 AI 或語言模型。）\n\n",
      en:
    ...
    // newChatPath overlaps intentionally with isOverlayPath's "/app" — same rationale as chatgpt.js. TODO(T4-E): confirm if Gemini exposes a dedicated new-chat query param.
